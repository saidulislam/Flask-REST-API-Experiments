import requests # you have to install this package, requests
from cachetools import cached, TTLCache # install package cachetools
...
class OpenExchangeClient:
    ...
    @property
    @cached(cache=TTLCache(maxsize=2, ttl=900)) # caching every 900 seconds
    def latest(self):
